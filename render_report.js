            ...
            options: {
                ...
                scales: {
                    y: {
                        ...
                        grid: {
                            color: ctx => ctx.tick.value === 50 ? '#c0392b' : ctx.tick.value === 100 ? '#d4a017' : '#e0e0e0',
                            lineWidth: ctx => (ctx.tick.value === 50 || ctx.tick.value === 100) ? 2 : 1
                        }
                    },
...
.r-sidebar a { display: block; padding: 5px 20px; color: #aaa; text-decoration: none; border-left: 3px solid transparent; }
